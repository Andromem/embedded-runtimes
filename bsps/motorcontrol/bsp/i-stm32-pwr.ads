...
package Interfaces.STM32.PWR is
   ...
   subtype CR_FMSSR_Field is Interfaces.Bit_Types.Bit;
   subtype CR_FISSR_Field is Interfaces.Bit_Types.Bit;
   ...
   subtype CSR_EWUP2_Field is Interfaces.Bit_Types.Bit;
