...
package Interfaces.STM32.RCC is
   ...
   subtype APB1RSTR_SPDIFRST_Field is Interfaces.Bit_Types.Bit;
   ...
   subtype APB1RSTR_I2CFMP1RST_Field is Interfaces.Bit_Types.Bit;
   ...
   subtype APB1ENR_SPDIFEN_Field is Interfaces.Bit_Types.Bit;
   ...
   subtype APB1ENR_I2CFMP1EN_Field is Interfaces.Bit_Types.Bit;
   subtype APB1ENR_CAN1EN_Field is Interfaces.Bit_Types.Bit;
   subtype APB1ENR_CAN2EN_Field is Interfaces.Bit_Types.Bit;
   subtype APB1ENR_CEC_Field is Interfaces.Bit_Types.Bit;
   ...
   type AHB1LPENR_Register is record
      ...
      --  unspecified
      Reserved_8_11  : Interfaces.Bit_Types.UInt4 := 16#1#;
      ...
      --  unspecified
      Reserved_23_28 : Interfaces.Bit_Types.UInt6 := 16#3C#;
   ...
   type AHB2LPENR_Register is record
      ...
      --  unspecified
      Reserved_1_6  : Interfaces.Bit_Types.UInt6 := 16#38#;
   ...
   subtype APB1LPENR_SPDIFLPEN_Field is Interfaces.Bit_Types.Bit;
   ...
   subtype APB1LPENR_I2CFMP1LPEN_Field is Interfaces.Bit_Types.Bit;
   ...
   subtype PLLI2SCFGR_PLLI2SM_Field is Interfaces.Bit_Types.UInt6;
   subtype PLLI2SCFGR_PLLI2SN_Field is Interfaces.Bit_Types.UInt9;
   subtype PLLI2SCFGR_PLLI2SP_Field is Interfaces.Bit_Types.UInt2;
   ...
   subtype PLLSAICFGR_PLLSAIM_Field is Interfaces.Bit_Types.UInt6;
   ...
   subtype DCKCFGR_SAI1SRC_Field is Interfaces.Bit_Types.UInt2;
   subtype DCKCFGR_SAI2SRC_Field is Interfaces.Bit_Types.UInt2;
   subtype DCKCFGR_TIMPRE_Field is Interfaces.Bit_Types.Bit;
   subtype DCKCFGR_I2S1SRC_Field is Interfaces.Bit_Types.UInt2;
   subtype DCKCFGR_I2S2SRC_Field is Interfaces.Bit_Types.UInt2;
   ...
   subtype CKGATENR_AHB2APB1_CKEN_Field is Interfaces.Bit_Types.Bit;
   subtype CKGATENR_AHB2APB2_CKEN_Field is Interfaces.Bit_Types.Bit;
   subtype CKGATENR_CM4DBG_CKEN_Field is Interfaces.Bit_Types.Bit;
   subtype CKGATENR_SPARE_CKEN_Field is Interfaces.Bit_Types.Bit;
   subtype CKGATENR_SRAM_CKEN_Field is Interfaces.Bit_Types.Bit;
   subtype CKGATENR_FLITF_CKEN_Field is Interfaces.Bit_Types.Bit;
   subtype CKGATENR_RCC_CKEN_Field is Interfaces.Bit_Types.Bit;
   ...
   subtype DCKCFGR2_FMPI2C1SEL_Field is Interfaces.Bit_Types.UInt2;
   subtype DCKCFGR2_CECSEL_Field is Interfaces.Bit_Types.Bit;
   subtype DCKCFGR2_CK48MSEL_Field is Interfaces.Bit_Types.Bit;
   subtype DCKCFGR2_SDIOSEL_Field is Interfaces.Bit_Types.Bit;
   subtype DCKCFGR2_SPDIFSEL_Field is Interfaces.Bit_Types.Bit;
