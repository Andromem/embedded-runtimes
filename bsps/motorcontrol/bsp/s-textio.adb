...
package body System.Text_IO is
   ...
   procedure Initialize is
      ...
      Pins         : constant array (1 .. 2) of Natural := (6, 7);
   ...
   begin
      ...
      for Pin of Pins loop
         GPIOC_Periph.MODER.Arr     (Pin) := Mode_AF;
         GPIOC_Periph.OSPEEDR.Arr   (Pin) := Speed_50MHz;
         GPIOC_Periph.OTYPER.OT.Arr (Pin) := Push_Pull;
         GPIOC_Periph.PUPDR.Arr     (Pin) := Pull_Up;
         GPIOC_Periph.AFRL.Arr      (Pin) := AF_USART6;
      end loop;
